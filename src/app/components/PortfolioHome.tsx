...
import { LiveClock, IsometricStack, type CardStackVariant } from "./CardStack";
...
import {
  getPortfolioItemHref,
  type PortfolioWorkItem,
} from "./portfolio-home-types";
...
export function PortfolioHome({
  ...
  const navigateToItem = (item: PortfolioWorkItem, index: number) => {
    const href = getPortfolioItemHref(item);
            ...
            >
              ...
              >
                <IsometricStack
                  ...
                  onSelectIndex={(i) => navigateToItem(items[i], i)}
                />
              </div>
            </div>
